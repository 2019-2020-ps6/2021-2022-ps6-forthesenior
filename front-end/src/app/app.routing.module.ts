...
const routes: Routes = [
  ...
  {path: ':idAccount/user-list/:idUser/quiz-play/:id/question/:numero', component: QuizPlayComponent},
  {path: ':idAccount/user-list/:idUser/result/:id/:right/:total', component: ResultComponent},
